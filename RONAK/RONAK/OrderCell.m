...
-(void)bindData:(ItemMaster *)item withCount:(int)Count customerData:(CustomerDataModel*)cst forCustome:(CustomButton *)btn
{
    ...
    _priceLabel.text=[NSString stringWithFormat:@"%0.2f",item.filters.wS_Price__c];
    _discountLabel.text=[NSString stringWithFormat:@"%0.2f",_item.filters.discount__c];
    _totalLabel.text=[NSString stringWithFormat:@"%0.2f",(item.filters.wS_Price__c*Count)];
